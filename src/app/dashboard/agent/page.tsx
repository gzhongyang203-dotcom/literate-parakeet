        ...
        <DialogContent>
          ...
          <div className="flex flex-col items-center gap-4 py-4">
            ...
            <div className="w-48 h-48 bg-white rounded-xl flex items-center justify-center border-2 border-gray-200 overflow-hidden">
              {stats?.inviteCode ? (
                <img
                  src={`https://api.2dcode.biz/v1/create-qr-code?data=${typeof window !== 'undefined' ? window.location.origin : 'https://literate-parakeet-mu.vercel.app'}/register?code=${stats.inviteCode}&size=300`}
                  alt="邀请二维码"
