    ...
    <div className="container mx-auto px-4 py-10 sm:py-16 flex justify-center">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardDescription>手机号登录，浏览全部创业项目</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <div className="relative py-2">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-card px-2 text-muted-foreground">微信用户</span>
            </div>
          </div>
          ...
          <p className="text-xs text-center text-muted-foreground">
            还没有账号？{" "}
            <a href={`/register${searchParams.get("code") ? `?code=${searchParams.get("code")}` : ""}`} className="text-primary hover:underline font-medium">
              立即注册
            </a>
          </p>
        </CardContent>
